...
import com.sqyi.yidada.model.dto.app.AppAddRequest;
import com.sqyi.yidada.model.dto.app.AppEditRequest;
import com.sqyi.yidada.model.dto.app.AppQueryRequest;
import com.sqyi.yidada.model.dto.app.AppUpdateRequest;
...
public class AppController {
    ...
    public BaseResponse<Boolean> deleteApp(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        User loginUser = userService.getLoginUser(request);
        // 仅本人或管理员可删除
        if (!oldApp.getUserId().equals(loginUser.getId()) && !userService.isAdmin(request)) {
