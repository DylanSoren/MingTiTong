...
import com.sqyi.yidada.constant.CommonConstant;
import com.sqyi.yidada.exception.ThrowUtils;
import com.sqyi.yidada.mapper.AppMapper;
import com.sqyi.yidada.model.dto.app.AppQueryRequest;
...
import com.sqyi.yidada.model.enums.ScoringStrategyEnum;
import com.sqyi.yidada.model.vo.AppVO;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        // 修改数据时，有参数则校验
        // 补充校验规则
        ThrowUtils.throwIf(StringUtils.isNotBlank(appName), ErrorCode.PARAMS_ERROR, "应用名称为空");
    ...
    public QueryWrapper<App> getQueryWrapper(AppQueryRequest appQueryRequest) {
        ...
        // 补充需要的查询条件
        // 从多字段中搜索，searchText为搜索框中的内容，不选择任何搜索类别直接搜索
